...
contract SavingsPoolFactory {
    address[] public deployedFunds;

    function createFund(string name, uint amount, uint installments, uint participants) public {
        address newFund = new SavingsPool(name, amount, installments, participants, msg.sender);
...
contract SavingsPool {
    ...
    function SavingsPool(string _name, uint _amount, uint _installments, uint _noOfParticipants, address creator) public {
        fundName = _name;
